...
courseRouter.get("/get-courses", auth_1.isAuthenticated, auth_1.isAdmin, user_controller_1.getallUsers);
courseRouter.delete("delete-course", auth_1.isAuthenticated, auth_1.isAdmin, course_controller_1.deleteCourse);
