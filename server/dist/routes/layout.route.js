...
layoutRouter.post("/create-layout", auth_1.isAuthenticated, auth_1.isAdmin, layout_controller_1.createLayout);
layoutRouter.put("/edit-layout", auth_1.isAuthenticated, auth_1.isAdmin, layout_controller_1.editLayout);
